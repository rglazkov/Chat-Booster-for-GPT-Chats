...
**Project layout**
- All extension files live in the repository root (`manifest.json`, `background.js`, `content.js`).
- Load the root folder directly in Chrome — no `src/` directory remains.
